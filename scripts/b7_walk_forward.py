...
`scripts/adaptive_rr_model_v2.py`. No retraining of the live V2 model —
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--output-dir", type=Path,
                   ...
                   help="Where to write b7_walk_forward.json + plot")
...
def main() -> None:
    ...
    results: dict = {
        "script": "scripts/b7_walk_forward.py",
    ...
    fig.tight_layout()
    png_path = args.output_dir / "b7_walk_forward.png"
    fig.savefig(png_path, dpi=150)
    plt.close(fig)
    print(f"\n[b7] Saved {png_path}")

    out_path = args.output_dir / "b7_walk_forward.json"
