...
Usage:
    python scripts/models/adaptive_rr_model_v1.py
    python scripts/models/adaptive_rr_model_v1.py --versions 8 9 10
    python scripts/models/adaptive_rr_model_v1.py --max-rows 5000000
"""
...
def parse_args() -> argparse.Namespace:
    """Parse CLI arguments for the V2 held-out trainer."""
...
def main() -> None:
    """Train a V2 variant withholding a chronological test fold for OOS evaluation."""
    args = parse_args()
    t_start = time.time()
