"""B1 V3 variant: per-combo optimal filter threshold using V3 booster + Family A.

Mirrors filter_backtest_per_combo_v2.py but swaps V2 model + predict for V3
inference with Family A features and per-R:R isotonic calibration.

Output: data/ml/adaptive_rr_v3/filter_backtest_per_combo_v3.json
"""
...
OUT = REPO / "data/ml/adaptive_rr_v3/filter_backtest_per_combo_v3.json"
...
def main():
    ...
    all_results = {"model": "v3", "thresholds": THRESHOLDS,
    ...
    for gcid in existing:
        ...
        try:
            ...
            r = backtest_per_combo_v3(gcid, combo, booster, cals)
