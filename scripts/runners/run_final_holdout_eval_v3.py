...
UPLOAD_FILES = [
    "scripts/evaluation/final_holdout_eval_v3.py",
    "scripts/models/inference_v3.py",
]


def main():
    """Upload script + inputs to sweep-runner-1 via paramiko and launch Phase 5D (B16 final held-out eval).
...
python3 scripts/evaluation/final_holdout_eval_v3.py 2>&1 | tee /tmp/phase5d.log
