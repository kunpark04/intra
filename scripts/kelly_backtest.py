...
Simulate with fixed-equity sizing (matches filter_backtest convention) but
...
spec2 = importlib.util.spec_from_file_location(
    "fbs", REPO / "scripts/filter_backtest_surrogate.py")
fbs_ok = (REPO / "scripts/filter_backtest_surrogate.py").exists()
if fbs_ok:
