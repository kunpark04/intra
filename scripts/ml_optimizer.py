"""
ml_optimizer.py — LightGBM surrogate optimizer for MNQ strategy parameters.
...
Usage:
    ...
    python scripts/ml_optimizer.py --min-trades 50 --n-top 30
    python scripts/ml_optimizer.py --skip-aggregation   # reuse cached combo_features.parquet
    python scripts/ml_optimizer.py --versions 8 9 10    # only use specific versions
