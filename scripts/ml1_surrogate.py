...
Usage:
    python scripts/ml1_surrogate.py
    python scripts/ml1_surrogate.py --min-trades 50 --n-top 30
    python scripts/ml1_surrogate.py --skip-aggregation   # reuse cached combo_features.parquet
    python scripts/ml1_surrogate.py --versions 8 9 10    # only use specific versions
