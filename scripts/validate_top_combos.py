"""
validate_top_combos.py — Run top ML-recommended combos on the held-out test partition.
...
Usage:
    python scripts/validate_top_combos.py
    python scripts/validate_top_combos.py --n-top 10
    python scripts/validate_top_combos.py --partition both
    python scripts/validate_top_combos.py --tag high_freq  # saves as validation_high_freq.csv
"""
