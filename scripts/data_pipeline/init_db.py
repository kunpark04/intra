...
Usage:
    python scripts/data_pipeline/init_db.py              # create + backfill (idempotent)
    python scripts/data_pipeline/init_db.py --force      # drop all tables first, then recreate
    python scripts/data_pipeline/init_db.py --db-path custom.db
