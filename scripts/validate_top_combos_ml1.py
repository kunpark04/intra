...
Usage:
    python scripts/validate_top_combos_ml1.py
    python scripts/validate_top_combos_ml1.py --n-top 10
    python scripts/validate_top_combos_ml1.py --partition both
    python scripts/validate_top_combos_ml1.py --tag high_freq  # saves as validation_high_freq.csv
"""
