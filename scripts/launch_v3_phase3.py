...
Uploads v3_inference.py + the three filter_backtest_*_v3.py scripts,
...
UPLOADS = [
    "scripts/v3_inference.py",
    "scripts/filter_backtest_per_combo_v3.py",
    "scripts/filter_backtest_percentile_v3.py",
    "scripts/filter_backtest_surrogate_v3.py",
]
