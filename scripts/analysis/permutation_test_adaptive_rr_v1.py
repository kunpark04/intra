"""
permutation_test_adaptive_rr_v1.py — Verify adaptive R:R model's OOF AUC is not leakage.
...
import sys
# Import model module from scripts/models
sys.path.insert(0, str(Path(__file__).resolve().parents[2] / "scripts" / "models"))
import adaptive_rr_model_v1 as arr  # type: ignore  # noqa: E402
